        ...
        return <Box className={'about-fitness-club-box'}>
            ...
            <Box id={'about-fitness-club-box-items-container'}>
                <Typography variant={'h5'} marginTop={2}>
                    ...
                    Our state-of-the-art facility is equipped with the latest exercise
                    equipment and offers a wide range of services to cater to all fitness levels and preferences.
                </Typography>
                <Typography variant={'h5'} marginTop={2}>
                    &nbsp;&nbsp;&nbsp;Our experienced and certified trainers are dedicated to providing personalized attention
                    and
                ...
                <Typography variant={'h5'} marginTop={2}>
                    &nbsp;&nbsp;&nbsp;At Fitness Club, we pride ourselves on creating a positive and inclusive environment
                    where
                    members can feel comfortable and motivated. Our friendly staff is always available to assist you and
                    answer any questions you may have.
                </Typography>
                <Typography variant={'h5'} marginTop={2}>
                    &nbsp;&nbsp;&nbsp;Join us at FitLife Fitness Club and take the first step towards a healthier, fitter you.
                    We look
            ...
            <Typography variant="h3" id={'contacts-fitness-club-box-header'}>
                Our Contacts
            </Typography>
            <Box id={'contacts-fitness-club-box-items-container'}>
